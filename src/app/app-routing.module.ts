...
import { CompresssidebarLayoutComponent } from './layouts/compress-sidebar/compress-sidebar.component';
import { BoxedvisibleLayoutComponent }  from './layouts/boxed-compress/boxed-compress.component';
...
const routes: Routes = [
  ...
  {
    path: 'compress-sidebar-layout',
    component: CompresssidebarLayoutComponent,
    children: visiblesidebarRoutes
  },
  {
    path: 'boxed-layout',
  ...
  {
    path: 'boxed-compress-layout',
    component: BoxedvisibleLayoutComponent,
